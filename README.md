## <p dir="rtl">أفضل الممارسات في إطار العمل لارافيل </p>
...
[<p>نمط المسؤولية الواحدة</p>](#1)

[<p>شيفرة أكثر في النماذج، شيفرة أقل في المتحكمات</p>](#2)

[<p>التحقق</p>](#3)

[<p>الشيفرات المنطقية يجب أن تكون في فئة خادمة منفصلة</p>](#4)

[<p>لا تكرر نفس الشيفرة</p>](#5)
،
[<p>يفضل استخدام نظام التعامل مع قواعد البيانات المسمى بـEloquent بدل استخدام باني الإستعلامات Query Builder أو الاستخدام المباشر لأوامر الإستعلامات SQL عبر raw، ويفضل استخدام المجموعات بدل المصفوفات</p>](#6)

[<p>تقليص المهام</p>](#7)

[<p>لا تقم بتنفيذ الإستعلامات داخل ملفات blade واستخدم التحميل الحثيث مشكلة (N+1)</p>](#8)

[<p>اضف التعليقات للشيفرة ويفضل استخدام صيغ التعليقات القياسية للمتغيرات والخواص والقيم المعادة إلخ</p>](#9)

[<p>لا تضع شيفرات js و css داخل ملفات Blade ولا تضع أي ششفرات HTML في فئات php</p>](#10)

[<p>استخدم ملفات الإعدادت واللغات، والثوابت بدلاً من النص داخل الشيفرة</p>](#11)

[<p>استخدم الأدوات القياسية المعتمدة من مجتمع لارافيل</p>](#12)

[<p>اتبع طريقة لارافيل في التسميات</p>](#13)

[<p>استخدم شيفرة أقصر قابلة للقراءة والفهم السريع قدر المستطاع</p>](#14)

[<p>استخدم الحاويات أو الواجهات بدلاً من الفئات الجديدة</p>](#15)

[<p>لا تقم بجلب البيانات من ملف `.env`</p>](#16)

[<p>احفظ البيانات في الشكل القياسي. استخدم المسترجعات والمُعدلات في تعديل شكل صيغة التاريخ</p>](#17)

[<p>ممارسات جيدة أخرى</p>](#18)
### <p>1</p>
### **<p>Single Liability Pattern</p>**

<p>The category and method function must be a single responsibility only. in other words the class or method must not be multi-tasking and must be concerened with onlly one task</p>
...
[<p>🔝 الرجوع للفهرس</p>](#الفهرس)

### <p>2</p>
### **<p>More code in models, less code in cotrollers/p>**

<p>Put all the code for dealing with databases in seperate special categories. Do not put them in the controllers</p>
<p>❌ Bad Way</p>
